...
public:
    ...
    std::string reset(const std::string &workDir, const std::string &commitHash) noexcept;
private:
    ...
    int copyUnmodifiedFiles(const std::string &headHash, const std::string &newHash) noexcept;
